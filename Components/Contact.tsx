    ...
    <div>
        ...
        <div className="flex items-center  max-w-8xl mx-auto leading-5 mt-10  md:flex-row flex-col" id="contact">
            ...
            <div className='flex flex-col mt-10 md:mt-0 '>
             ...
             <div className='flex flex-row md:px-20 md:mx-0 mt-8 items-center text-lg text-black'>
             ...
             <div className="pt-10  items-center mt-5 w-full sm:w-[100%] flex-row justify-around gap-4 md:px-20 md:mx-0  text-red-900 grid grid-cols-6 sm:grid-cols-4 md:grid-cols-6">
