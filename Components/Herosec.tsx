...
export const Herosec = () =>{
    ...
    return(
        <section className="flex items-center text-justify justify-around gap-0 md:flex-row flex-col  md:max-w-full max-w-full max-h-screen">
            <div className="md:max-w-full max-w-auto px-15 md:mt-8 sm:mt-8">
